...
<head>
    <meta charset="UTF-8">
    <title>Nexacore - REGISTRO DE DEVOLUÇÃO DE EQUIPAMENTO</title>
...
<script>
    ...
    // Injeta a flag de devolução forçada e o ID recuperado pelo Servlet
    window.isDevolucaoForcada = true;
    window.idEquipamentoDevolucaoForçado = "${param.idEquipamento}"; // Garante a captura correta do parâmetro da URL
